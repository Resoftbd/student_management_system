		...
		<!-- Main content-->
				...
				<div class="col-sm-9">
					<h3>Remarks</h3>
						...
						<ul class="inbox">
							<li class="unread"><input type="checkbox" data-toggle="toggle" style="margin:3px 5px;"><a href="#msg" data-toggle="modal" data-target="#msg">Remark Title- 19/2/2017- Hello! I'm tazwar utshas and I really loved your website...</a></li>
							  ...
							  <div class="modal-dialog">
								...
								<div class="modal-content">
								  <div class="modal-header">
									...
									<h4 class="modal-title black1">Remark Title</h4>
								  </div>
								  <div class="modal-body">
								    <b>Date: 19/1/12</b><br><br>
